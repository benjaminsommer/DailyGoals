 ...
 */
public class StatisticByDateFragment extends Fragment {
    ...
    private CharSequence[] chartHeadline = {"Zielverteilung", "Geld"};
    private CharSequence[] chartTimeframe = {"Tag", "Woche", "Monat", "Jahr"};

    public StatisticByDateFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_statistic_by_date, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout) getView().findViewById(R.id.statisticFragmentByDate_linearLayout);
        buttonChart = (Button) getView().findViewById(R.id.statisticFragmentByDate_buttonChart);
        buttonTime = (Button) getView().findViewById(R.id.statisticFragmentByDate_buttonTimeframe);
        ...
        generateStackedBarChart(diagramNumber, timeNumber);

    }

    private void generateStackedBarChart(int chartID, int timeframe) {
        ...
        ArrayList<SummarizedDataSet> dateValues = db.getSummarizedDataSetByTimeframe(0, timeframe); // 0 because in this case always all goals!
