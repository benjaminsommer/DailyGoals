...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    public NetworkBoundResource(AppExecutors appExecutors) {
        ...
        ResultType test = null;
        result.setValue(Resource.loading(test));
                    ...
                    appExecutors.diskIO().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            appExecutors.mainThread().execute(new Runnable() {
                                @Override
                                public void run() {
                                    // we specially request a new live data, otherwise we will get immediately last cached value, which may not be updated with latest results received from network
